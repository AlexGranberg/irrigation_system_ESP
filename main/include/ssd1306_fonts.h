...
extern const uint8_t c_chWiFiConnected88[8];
extern const uint8_t c_chWiFiDisconnected88[8];
extern const uint8_t c_chwaterSquareEmpty88[8];
extern const uint8_t c_chwaterSquareQuarter88[8];
extern const uint8_t c_chwaterSquareHalf88[8];
extern const uint8_t c_chwaterSquareThreeQuarter88[8];
extern const uint8_t c_chwaterSquareFull88[8];
